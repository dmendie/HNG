...
namespace SimpleValidator.Extensions
{
    ...
    public static class ExtensionMethods
    {
        ...
        public static bool IsEmail(this string value)
        {
            ...
            {
                var exp = @"^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-||_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+([a-z]+|\d|-|\.{0,1}|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])?([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))$";
        ...
        public static bool IsNotZero<T>(this T value) where T : INumber<T>
        {
            return value.ToDouble() != 0;
        }

        public static bool Is<T>(this T value, T compare) where T : INumber<T>
        {
            return value == compare;
        }

        public static bool IsGreaterThan<T>(this T value, T min) where T : INumber<T>
        {
            return (value >= min);
        }

        public static bool IsLessThan<T>(this T value, T max) where T : INumber<T>
        {
            return (value <= max);
        }
        ...
        public static bool Is<T>(this object value)
        {
            ...
            try
            {
                ...
                {
                    T? result = string.IsNullOrEmpty(value.ToString()) ? default(T) : (T?)converter.ConvertFromString(value.ToString() ?? String.Empty);
                    return result != null;
                }
