...
namespace SimpleValidator
{
    ...
    public partial class Validator
    {
        ...
        public Validator CheckForDuplicates<T, TKey>(IEnumerable<T> items,
          Expression<Func<T, TKey>> keySelector,string name = "Collection")
        {
            if (items == null)
            {
            ...
            var propertyInfo = (keySelector.Body as MemberExpression)?.Member;
            ...
            foreach (var item in items)
            {
                ...
                {
                    string message = $"Duplicate {propertyName} values are not allowed.";
