namespace HNG.Abstractions.Services.Infrastructure
{
    public interface IMappingService
    {
        ...
        /// <param name="source">SourceDTO object to map from</param>
        /// <returns>Mapped destination object</returns>
        TDestination Map<TDestination>(object source);
        /// <summary>
        /// Execute a mapping from the source object to a new destination object.
        /// </summary>
        /// <typeparam name="TSource">SourceDTO type to use, regardless of the runtime type</typeparam>
        /// <typeparam name="TDestination">Destination type to create</typeparam>
        /// <param name="source">SourceDTO object to map from</param>
        /// <returns>Mapped destination object</returns>
        ...
        /// </summary>
        /// <typeparam name="TSource">SourceDTO type to use</typeparam>
        ...
        /// </summary>
        /// <param name="source">SourceDTO object to map from</param>
        /// <param name="sourceType">SourceDTO type to use</param>
